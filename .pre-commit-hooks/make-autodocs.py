...
src_dir = repo_path / "src" / "saltext" / "salt-convert"
...
for path in Path(__file__).parent.parent.joinpath("src/saltext/salt-convert/").glob("*/*.py"):
